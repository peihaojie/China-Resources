<template>
  <div id="systemHome">
    ...
    <div class="centent">
        ...
        <div class="top-box">
          ...
          <div class="top-right">
            <div class="autonym">
              ...
              <div class="attendance-graph" id="attendance"></div>
            </div>
            <div class="TSP">
              <div class="title">
                <i class="icon"></i>
      ...
      <div class="slideshow">
        <el-carousel height="8.5rem" trigger="click">
          <el-carousel-item>
...
export default {
  ...
  methods: {
        ...
        series: [
          {
            ...
            data: [{ value: 0, name: "载重" }, { value: 0, name: "重量" }]
          }
        ]
      });
    },
    ...
    // 升降机ECharts渲染
    setElevator() {
      let elevator = this.$echarts.init(document.getElementById("elevator"));
      elevator.setOption({
        color: ["#3ada76", "#ff7a81"],
        tooltip: {
          trigger: "item",
        ...
        series: [
          {
            ...
            data: [{ value: 0, name: "漏电" }, { value: 0, name: "温度" }]
          }
        ]
      });
    },
