      ...
      <div class="main">
        ...
        <router-link to="/green" class="mianInfo">
            <div class="global" v-for="(item,index) in dustEmissionCentreData.newData" :key="index">
              <div class="title">PM2.5</div>
              <div class="num">{{item.PM25}}<span style="fontSize:0.32rem">μg/m³</span></div>
              <div class="yuan">
    ...
    <div id="right">
      ...
      <div class="up">
        ...
        <div class="title">
          ...
          <span class="content">
            电箱运行状态：
            <span class="noml" v-if="this.tableData[0]">正常</span>
            <span class="danger" v-else>异常</span>
            <!-- <span class="danwei">&nbsp;kw/h</span> -->
          </span>
        </div>
        <div class="imgs">
          <div v-if="this.tableData[0]" :class="this.tableData[0].doorType==0?'loudian':'loudian1'">
            <div class="text">
              <p style="font-size:.2rem; line-height:.45rem">{{this.tableData[0].doorType==0?'关':'开'}}</p>
            </div>
          </div>
          <div v-if="this.tableData[0]" :class="this.tableData[0].envirwarm<45?'loudian':'loudian1'">
            <div class="text">
              <p>{{this.tableData[0].envirwarm}}</p>
              <p>℃</p>
            </div>
          </div>
          <div v-if="this.tableData[0]" :class="this.tableData[0].current<150?'loudian':'loudian1'">
            <div class="text">
        ...
        <div class="subtitle" v-if="this.tableData[0]">
          <p :class="this.tableData[0].doorType==0?'huang':'danger'">箱门开关</p>
          <p :class="this.tableData[0].envirwarm<45?'huang':'danger'">电箱温度</p>
          <p :class="this.tableData[0].current<150?'huang':'danger'">电箱漏电</p>
          <!-- <p v-else class="danger">电箱漏电</p> -->
        </div>
        <!-- <div class="door-state">
          <div class="door-title">电箱开关</div>
        ...
        <div class="door-wrap">
          ...
          <div class="table-body">
            <div class="table-rows" v-for="(item, index) in tableData" :key="index">
              <!-- <div class="table-block">{{index}}</div>
              <div class="table-block">{{item.current}}kw/h</div>
              <div class="table-block">{{item.doorType == 0?'关':'开'}}</div>
              <div class="table-block">{{item.envirwarm}}<sup>o</sup>C</div> -->
...
export default {
  ...
  methods: {
    ...
    geteElectric() {
      this.$axios
        .post(`/api/appProjectElectricityBox/getBoxList?pid=${this.pid}`)
        .then(res => {
          // console.log(res.data)
